...
if ( ! function_exists( 'olr_render_research_catalog' ) ) {
	...
	function olr_render_research_catalog() {
		...
		body :is(#olr-catalog-shortcode-type-system, .olr-research-catalog) :where(*) { font-family: var(--olr-font, -apple-system, BlinkMacSystemFont, "Segoe UI", Arial, Helvetica, sans-serif) !important; }
