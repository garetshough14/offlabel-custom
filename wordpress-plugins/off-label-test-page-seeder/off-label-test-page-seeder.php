...
final class OLR_Test_Page_Seeder {
	...
	public static function frontend_assets() {
		...
		if ( 'research-item' === $slug ) {
			...
			/* Reuse the production handles so the bridge cannot print the same assets twice. */
			wp_enqueue_style( 'olr-product-record', self::ASSET_BASE . 'styles-product.css', array(), self::VERSION );
			wp_enqueue_script( 'olr-product-detail', self::ASSET_BASE . 'scripts/olr-product-detail.js', array( 'jquery' ), self::VERSION, true );
		}

		if ( 'receipt-test' === $slug ) {
			wp_enqueue_style( 'olr-coa-detail', plugins_url( 'off-label-coa-manager/assets/coa-detail.css' ), array(), self::VERSION );
			wp_add_inline_style(
				'olr-coa-detail',
				'body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__seal,
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__molecule{display:none!important}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__hero{display:block;min-height:0;padding-block:clamp(38px,5vw,68px) clamp(30px,4vw,52px);overflow:visible}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__identity{width:min(100%,920px)}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__crumb{flex-wrap:wrap;margin-bottom:clamp(28px,4vw,52px);line-height:1.45}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__identity h1{max-width:14ch;color:#050505!important;font-size:clamp(58px,7vw,102px);line-height:.92;overflow-wrap:anywhere;text-wrap:balance}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__identity h2{margin-top:clamp(28px,4vw,42px)}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__identity>p:not(.olr-coa-detail__crumb){max-width:520px;line-height:1.6}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__actions{flex-wrap:wrap;margin-top:28px}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__banner,
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__banner h2,
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__banner p{color:#fff!important}
@media(max-width:640px){
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__hero{padding-block:30px 26px}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__crumb{margin-bottom:24px}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__identity h1{max-width:100%;font-size:clamp(40px,13vw,58px);line-height:.94}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__identity h2{margin-top:24px}
body.olr-isolated-test-page.olr-coa-detail-page .olr-coa-detail__actions{margin-top:24px}
}'
			);
			wp_enqueue_script( 'olr-coa-detail', plugins_url( 'off-label-coa-manager/assets/coa-detail.js' ), array(), self::VERSION, true );
			wp_localize_script(
				'olr-coa-detail',
				'olrCoaViewer',
				array(
		...
		if ( in_array( $slug, array( 'account-test', 'affiliate-test', 'affiliate-guidelines-test' ), true ) ) {
			...
			wp_enqueue_style( 'olr-account-hub', plugins_url( 'off-label-account-hub/assets/account-hub.css' ), array(), self::VERSION );
			if ( 'account-test' === $slug ) {
				wp_add_inline_style(
					'olr-account-hub',
					'.olr-account-hub .um-account-side a.um-account-link .um-account-title{flex:1 1 0%!important;width:auto!important;min-width:0!important;max-width:none!important;overflow-wrap:normal;word-break:normal}.olr-account-hub .um-account-side a.um-account-link .um-account-arrow{flex:0 0 1.25rem!important;width:1.25rem!important;min-width:1.25rem!important;max-width:1.25rem!important;margin-left:auto!important;text-align:right}'
				);
			}
			wp_enqueue_script( 'olr-account-hub', plugins_url( 'off-label-account-hub/assets/account-hub.js' ), array(), self::VERSION, true );
			wp_localize_script(
				'olr-account-hub',
				'olrAccountHub',
				array(
		...
		if ( 'build-your-box-test' === $slug ) {
			wp_enqueue_style( 'olr-build-a-box', plugins_url( 'off-label-build-a-box/assets/build-a-box.css' ), array(), self::VERSION );
			wp_enqueue_script( 'olr-build-a-box', plugins_url( 'off-label-build-a-box/assets/build-a-box.js' ), array(), self::VERSION, true );
		}
		...
		if ( 'checkout-test' === $slug ) {
			wp_enqueue_style( 'olr-checkout-test', plugins_url( 'off-label-checkout-test/assets/checkout-test.css' ), array(), self::VERSION );
			wp_add_inline_style(
				'olr-checkout-test',
				'.olr-checkout-test .olr-checkout-test__steps button{background:transparent!important;box-shadow:none!important;color:var(--olr-checkout-muted)!important}.olr-checkout-test .olr-checkout-test__steps button[aria-current="step"]{color:var(--olr-checkout-ink)!important}@media(max-width:900px){body.olr-checkout-test-page .olr-checkout-test form.checkout,body.olr-checkout-test-page .olr-checkout-enhanced[data-olr-checkout-stage="payment"] form.checkout{grid-template-columns:minmax(0,1fr)!important}body.olr-checkout-test-page .olr-checkout-test form.checkout>#customer_details{grid-column:1!important;grid-row:1!important}body.olr-checkout-test-page .olr-checkout-test form.checkout>#order_review_heading{grid-column:1!important;grid-row:2!important}body.olr-checkout-test-page .olr-checkout-test form.checkout>#order_review{grid-column:1!important;grid-row:3!important}}'
			);
		}
	}
