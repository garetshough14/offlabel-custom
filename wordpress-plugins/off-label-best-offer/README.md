...
Install Best Offer 0.3.1 before Build Your Box 1.3.4. Both box versions 1.3.3 and 1.3.4 pass the compatibility check during this update. All other compatibility gates and existing enable/preview settings remain unchanged.
