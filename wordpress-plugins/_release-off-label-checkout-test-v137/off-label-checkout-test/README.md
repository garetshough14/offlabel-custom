...
Current build: **1.3.7**. This release keeps the progress controls transparent and restores their intended contrast even when the active theme applies a global button background, while retaining the final 320px wrapping guards, global GitPress header/footer, and all existing checkout behavior.
