...
The checkout footer uses the same canonical WebP logo and system sans-serif type stack as the managed GitPress site. The isolated route removes the managed site header, announcement, theme header, and logged-in WordPress admin bar so checkout begins flush at the top of the page.
